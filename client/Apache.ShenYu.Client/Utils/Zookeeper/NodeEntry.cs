...
namespace Apache.ShenYu.Client.Utils
{
    internal class NodeEntry
    {
        ...
        /// <summary>
        /// nodedata change delegate
        /// </summary>
        private NodeDataChangeHandler _dataChangeHandler;

        /// <summary>
        /// child node change delegate
        /// </summary>
        ...
        public async Task<string> CreateOrUpdateAsync(byte[] data, List<ACL> acls, CreateMode createMode)
        {
            string path = Path;
            ...
            {
                path = await CreateAsync(data, acls, createMode);
            }

            return path;
        }

        public async Task<bool> CreateWithParentAsync(byte[] data, List<ACL> acl, CreateMode createMode)
        {
